    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?=IMG?>/usuario.png" alt="User Image">
        <div>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item"  href="#" data-toggle="treeview-menu"><i class="app-menu__icon fa fa fa-users" aria-hidden="true"></i><span class="app-menu__label">Usuarios</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        ...
        <li><a class="app-menu__item" href="<?= BASE_URL?>Clientes"><i class="app-menu__icon fa fa-male" aria-hidden="true"></i><span class="app-menu__label">Clientes</span></a></li>
